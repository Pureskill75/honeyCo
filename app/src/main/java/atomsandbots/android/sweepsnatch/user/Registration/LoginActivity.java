...
import atomsandbots.android.sweepsnatch.user.AdminPanel.AdminMainActivity;
import atomsandbots.android.sweepsnatch.user.R;
import atomsandbots.android.sweepsnatch.user.RoomDatabase.DataBaseAdapter;
import atomsandbots.android.sweepsnatch.user.UI.ForgotPasswordActivity;
import atomsandbots.android.sweepsnatch.user.UI.MainActivity;
import atomsandbots.android.sweepsnatch.user.databinding.ActivityLoginBinding;
